        ...
        <LinearGradient id='Main-page' colors={['#ffffff', '#ffffff']} style={{...theme.main_screen}} >
            ...
            <View
                ...
                <StepList
                    ...
                    statusColor={Object.keys(props.signup.step_1).length > 0 ? '#449284' : '#F6756B'}
                />
                <StepList
                    ...
                    statusColor={Object.keys(props.signup.step_2).length > 0 ? '#449284' : '#F6756B'}
                />
                <StepList
                    ...
                    bulletNumber='3'
                    statusColor={Object.keys(props.signup.step_3).length > 0 ? '#449284' : '#F6756B'} />
                <StepList
                    onPress={() => { props.navigation.navigate('BankInformation') }}
                    status={Object.keys(props.signup.step_4).length > 0 ? 'Completed' : 'Incomplete'}
                    statusColor={Object.keys(props.signup.step_4).length > 0 ? '#449284' : '#F6756B'}
