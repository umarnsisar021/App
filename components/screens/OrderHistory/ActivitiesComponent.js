                      ...
                      data.map((row,index)=>{
                        return     <View key={index}>
                                    <TouchableOpacity
                                        ...
                                        style={{ backgroundColor: row.job_id == props.onGoingJob.id ? "#126d5d2b" : '#F8F8F8', paddingHorizontal: 15, paddingVertical: 15, marginVertical: 5, borderRadius: 5, borderColor:'#E9E8E8',borderWidth:1}}>
                                        {/* ROW */}
                                        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                                            ...
                                            <View>
                                                <Text style={{ ...theme.f_12, ...theme.pl_10, ...theme.pr_10, backgroundColor: '#00C406', ...theme.br_50,...theme.white}} >{row.current_job_status}</Text>
                                                {row.job_id == props.onGoingJob.id ? <Text style={{ ...theme.f_12, ...theme.pl_10, ...theme.pr_10, backgroundColor: '#FFA253',...theme.br_50,...theme.black, alignSelf:'flex-end', ...theme.mt_5}} >Ongoing</Text> : <></>}
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between',marginTop:20}}>
                                            <View style={{...theme.row,...theme.align_center}}>
                                                <Icon
                                                    ...
                                                    size={28}
                                                />
                                                <Text style={{ ...theme.f_20, color:'#7B7B7B',...theme.pl_5}}>#{row.job_id}</Text>
                                            </View>
