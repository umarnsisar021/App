    ...
    render() {
        ...
        <View style={{ flex: 1 }}>
            ...
            <MapView style={{ flex: 1 }}
                ...
                initialRegion={{
                    latitude: this.props.user.location.latitude ? this.props.user.location.latitude : 0.0,
                    longitude: this.props.user.location.longitude ? this.props.user.location.longitude : 0.0,
                    latitudeDelta: LATITUDE_DELTA,
                    longitudeDelta: LONGITUDE_DELTA,
                }}>
